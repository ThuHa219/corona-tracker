...
public PasswordAuthentication(int cost)
   ...
   */
  @Deprecated
  public static boolean checkPassword(String password, String token)
  {
...
public static void main(String[] args) {
	...
	System.out.println(auth.hash(pass));
	System.out.println(auth.checkPassword("hehe", auth.hash(pass)));
}
}